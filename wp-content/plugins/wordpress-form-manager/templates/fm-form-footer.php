<?php
/*
Template Name: Form Manager Footer
...
<?php echo fm_form_start(); ?>
	...
	<?php if($showBorder): ?><fieldset><?php endif; ?>
		...
		<div>
			<!--<a href="javascript:submitform()" style="background-color: #e28f23;padding: 2px 15px 2px 15px;color: #fff;text-transform: uppercase;font-size: 18px;height: 30px;">
				Submit
			</a>
		-->
