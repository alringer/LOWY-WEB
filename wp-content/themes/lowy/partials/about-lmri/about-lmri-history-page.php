...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <div>
                <h3><?php echo apply_filters( 'the_title', $about_lmri_history_page->post_title, $about_lmri_history_page->ID )  ?></h3>

            </div>

            <div class="single-page-template__article-content">
                <?php
                echo '<p>'. apply_filters( 'the_content',( $about_lmri_history_page->post_content ) ) .'</p>';                  
            ...
            <div class=" ">
                <?php if($canBeEdited) {
                    echo '<a href=" '.get_edit_post_link($about_lmri_history_page->ID, 'none').' ">Edit</a>';
                } ?>
            </div>
