<?php $board_directors_page = get_page(32); ?>
<?php 
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-8">
                <div class="single-page-template__card-title ">
                    <!-- <h3><?php //the_title(); ?></h3> -->
                    <h3><?php echo apply_filters( 'the_title', $board_directors_page->post_title, $board_directors_page->ID )  ?></h3>
                </div>
                
                <?php //echo '<p>'. apply_filters( 'the_content',( $about_lmri_cards_id->post_content ) ) .'</p>'; ?> 
                
                <?php echo '<p>'. strip_shortcodes( apply_filters( 'post_content', wp_trim_words( $board_directors_page->post_content, 14, "" ) ) ) .'</p>';  ?>
                ...
                <div>
                    <a href="<?php echo get_permalink($board_directors_page->ID); ?>" class="read-more-btn"> Read More  <span class=""></span></a>
                </div>  

                <div class="can-edit-wrap">
                    <?php if($canBeEdited) {
                        echo '<a href=" '.get_edit_post_link($board_directors_page->ID, 'none').' ">Edit</a>';
                    } ?>
                </div>
